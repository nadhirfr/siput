...
public class PengeluaranUser {
    ...
    public PengeluaranUser(int pengeluaran_user_id, boolean pengeluaran_user_status, int user_id, int pengeluaran_id, int transaksi_id) {
    ...
    public PengeluaranUser(boolean pengeluaran_user_status, int user_id, int pengeluaran_id, int transaksi_id) {
        this.pengeluaran_user_status = pengeluaran_user_status;
        this.user_id = user_id;
        this.pengeluaran_id = pengeluaran_id;
        this.transaksi_id = transaksi_id;
